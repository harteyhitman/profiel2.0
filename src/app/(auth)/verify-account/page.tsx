...
export default function VerifyAccountPage() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.response?.data?.error || err.message || 'Failed to resend verification email.');
    } finally {
    ...
    <div className={styles.verifyPage}>
      <div className={styles.logoHeader}>
        ...
        <p className={styles.subtitle}>
          {token ? 'Verifying your account...' : 'Please verify your email address to continue'}
        </p>
